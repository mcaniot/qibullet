...
from agents.agents_kerasrl import KerasCEMAgent, KerasDDPGAgent, KerasDDQNAgent, KerasDQNAgent, KerasNAFAgent
...
class Trainer:
    ...
    def setup_exercise(self, opts):
            ...
            # Ctrl + C.
            agent.train(env, nb_steps=opts.train_for, visualize=self.visualize, verbosity=0)
...
if __name__ == "__main__":
    ...
    exec("from pybullet_envs.gym_locomotion_envs import %s" % opts.env) # import env type
